...
LDFLAGS_PROD := $(LDFLAGS_PROD) -X gitlab.com/pbernier3/orax-cli/ws.urlStr=wss://orchestrator.oraxpool.com
...
LDFLAGS_TEST := $(LDFLAGS_TEST) -X gitlab.com/pbernier3/orax-cli/ws.urlStr=wss://orchestrator.luciap.ca
